...
#define STRING_CONFIG_H_AUTHOR "(Anthony R Sleck, Ender-3 0.02)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender Wigginns"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43.00, -10.00, -2.21 }
